...
#    define LOGL(fmt, ln, ...) lx::debugLogFormat(__PRETTY_FUNCTION__, fmt, ln __VA_OPT__(, ) __VA_ARGS__)
#    define LOGLNPF(fmt, ln, ...) lx::debugLogFormat(nullptr, fmt, ln __VA_OPT__(, ) __VA_ARGS__)
